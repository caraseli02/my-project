<template>
    <Layout>
      <section id="container-centre" class="column centre flex-1">
        <h1 class="page-title mt-16 text-center text-3xl md:text-center md:text-5xl mb-16 lg:mb-24 lg:text-6xl">DailyStyleBlog</h1>
        <div class="px-2">
            ...
            >
              <article class="article-card bg-white overflow-hidden rounded-lg shadow-lg flex-1">
                <g-link
                  ...
                  :to="entry.node.path"
                >
                  <ul class="absolute top-0 left-0 flex p-2 z-10">
                    <li class="mr-2">
                      <span
