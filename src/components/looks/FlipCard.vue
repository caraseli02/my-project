    ...
    <ul class="mt-6 flex justify-center">
      ...
      >
        <transition name="flip">
          <div :key="flipped">
            <div v-if="!flipped" class="bg-ds2 relative max-w-xs my-auto rounded overflow-hidden shadow-lg">
              <svg class="absolute ml-2 mt-2" aria-hidden="true" focusable="false" width="1.1em"
              ...
              <g-image class="w-2/4 mx-auto"
                       :alt="look.node.image_caption"
                       :src="look.node.image"></g-image>
              <section class="bg-white rounded-t-xl">
                <div class="px-6 py-4">
                  <div class="font-bold text-xl flex justify-between mb-2">Marka <span class="text-sm">19.99</span>
                  </div>
                </div>
            ...
            <div v-if="flipped" class="max-w-xs rounded overflow-hidden shadow-lg">
              <vue-glide v-model="active" class="" :startAt=2 :per-view=1>
                <vue-glide-slide class=" grid gap-2 grid-cols-2 glideSize "
