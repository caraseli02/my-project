<template>
  <article class="content setSize relative z-10  max-w-3xl mx-auto">
    <div class="relative flex justify-center items-center overflow-hidden
      ...
      <div class="z-10 h-screen company text-white
                transform rotate-45 translate-y-56 translate-x-40 hidden lg:block">
        <h6 class="text-5xl bg-ds w-full pl-4 rounded-r-full rounded py-6" v-for="(mark , index) in marks" :key="index">
          {{mark}}</h6>
      </div>
    </div>
    <div class="z-20 absolute w-full textBg">
      <div class="glass-dark max-w-xl mx-auto w-full">
      ...
      <p class="text-2xl text-white px-4 text-center glass-dark max-w-xl mx-auto w-full p-4">
        ...
        <g-link
          ...
          to="/looks">looks gallery &#8594;</g-link>
        <g-link
          class="block bg-black hover:bg-gray-100 text-gray-300 py-2 px-4 mt-4 rounded-full shadow-lg text-lg font-bold"
          to="/blog">fashon blog &#8594;</g-link>
      </p>
    </div>
  </article>
</template>
